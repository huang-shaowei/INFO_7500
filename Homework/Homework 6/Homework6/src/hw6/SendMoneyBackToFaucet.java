...
public class SendMoneyBackToFaucet {
    ...
    public static void main(String[] args) throws InsufficientMoneyException {
        ...
        //Transaction transaction = kit.wallet().createSend(Address.fromBase58(kit.params(), FAUCET_ADDRESS), Coin.CENT);
        Transaction transaction = kit.wallet().createSend(Address.fromBase58(kit.params(), FAUCET_ADDRESS), kit.wallet().getBalance().subtract(Coin.CENT));
